...
public class task8 extends JFrame{
    ...
    public task8() {
        ...
        try {
            ...
            Object grandParent = graph.insertVertex(parent, null, "", 50, 180, 56, 21, "opacity=0;foldable=false;verticalLabelPosition=top;resizable=false;connectable=false;perimeter=unaryTopPerimeter");
            Object _parent = graph.insertVertex(grandParent, null, "", 3, 3, 50, 15, "opacity=0;foldable=false;verticalLabelPosition=top;resizable=false;connectable=false;perimeter=unaryTopPerimeter");
